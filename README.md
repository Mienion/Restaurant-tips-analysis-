...
print(common_tip_min, common_tip_max, common_tip_mean, common_tip_median)
```
...
print(smokers_tip_min, smokers_tip_max, smokers_tip_mean, smokers_tip_median)
```
...
print(non_smokers_tip_min, non_smokers_tip_max, non_smokers_tip_mean, non_smokers_tip_median)
```
...
plt.show()
```
![all text](https://github.com/Mienion/Restaurant-tips-analysis-/blob/main/hihi1.png)
